  ...
  return (
    <div className="relative">
      <Link to={`/comics/${comicsId}/volumes/${comic.id}`}>
        ...
        <div className="absolute flex items-center justify-center group inset-0 z-10 hover:bg-opacity-70 bg-gray-900 bg-opacity-0 transition">
          <div className="opacity-0 group-hover:opacity-100 transition text-gray-100">{comic.name}</div>
        </div>
      </Link>
    </div>
  )
